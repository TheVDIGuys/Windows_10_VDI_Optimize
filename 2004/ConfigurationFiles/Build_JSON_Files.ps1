...
$AppxPackagesJson | Out-File .\2004\ConfigurationFiles\AppxPackages.json
...
$AutoLoggers | Out-File .\2004\ConfigurationFiles\Autologgers.Json
...
$ScheduledTasksJson | Out-File .\2004\ConfigurationFiles\ScheduledTasks.json
...
$ServicesJson | Out-File .\2004\ConfigurationFiles\Services.json
#endregion Services
...
Unload HKLM\Temp
"@
$UserSettingsKeys | Out-File .\2004\ConfigurationFiles\DefaultUserSettings.txt
#endregion
...
"@
$DiskCleanKeys | Out-File .\2004\ConfigurationFiles\DiskCleanRegSettings.txt
#endregion
